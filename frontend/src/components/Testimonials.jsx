const TestimonialCard = ({ quote, name, service, rating }) => (
  <div className="card bg-green shadow-lg">
    <div className="card-body">
      ...
      <p className="text-main-black">"{quote}"</p>
      <div className="card-actions justify-end mt-4">
        <div className="text-right">
          <p className="font-bold font-display text-main-orange">{name}</p>
          <p className="text-sm text-main-black">{service}</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="bg-base-100 -mx-4 px-4 py-16 md:py-24">
      <div className="container mx-auto">
        <div className="text-center mb-12">
            <h2 className="text-4xl font-display font-bold text-main-orange">What Our Clients Say</h2>
            <p className="text-lg mt-4 max-w-2xl mx-auto text-main-black">Real stories from satisfied customers in Lucknow.</p>
        </div>
