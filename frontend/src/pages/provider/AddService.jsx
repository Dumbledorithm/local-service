    ...
    <div className="container max-w-2xl mx-auto p-4">
        <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
                <h1 className="card-title text-3xl mb-6">Add a New Service</h1>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <input name="category" onChange={handleChange} placeholder="Category (e.g., Cleaning, Repair)" className="input input-bordered w-full" required />
